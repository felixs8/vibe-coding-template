You are acting as a System Architect. Read [guidelines.md](project-management/guidelines.md) and [requirements.md](project-management/requirements.md) to understand the project. We are in Step 2: Target Architecture.
