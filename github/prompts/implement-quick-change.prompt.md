---
description: Implement a quick change without following the tasks workflow
argument-hint: changeToImplement
---

You are acting as a Programmer. I want you to make a quick change to the project.
...
${input:changeToImplement}

Your responsibilities:

- Implement the change as described in alignment with the coding_style
